...
local function CreateMultiLineTextBox(rectransform, text, size)
    ...
    local textBox = GUI.TextBox(GUI.RectTransform(Vector2(1, 1), multineListBox.Content.RectTransform), text, nil, nil,
        nil, true, "GUITextBoxNoBorder")
    ...
    textBox.OnTextChangedDelegate = function()
        ...
        textBox.RectTransform.NonScaledSize = Point(textBox.RectTransform.NonScaledSize.X,
