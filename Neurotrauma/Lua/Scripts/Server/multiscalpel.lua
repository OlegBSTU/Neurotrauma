...
Hook.Add("NT.multiscalpel.incision", "NT.multiscalpel.incision",
...
Hook.Add("NT.multiscalpel.speedflex", "NT.multiscalpel.speedflex",
    function(effect, deltaTime, item, targets, worldPosition)
...
NT.ItemMethods.multiscalpel = function(item, usingCharacter, targetCharacter, limb)
        ...
        bandage = function(item, usingCharacter, targetCharacter, limb)
            ...
            if canCut then
                ...
                if not open then
                    ...
                    HF.AddAfflictionLimb(targetCharacter, "lacerations", limbtype, 2.5 + math.random() * 5,
                        usingCharacter)
                    ...
                    if istorso then
                        ...
                        HF.AddAfflictionLimb(targetCharacter, "lacerations", limbtype, 4 + math.random() * 6,
                            usingCharacter)
                        HF.AddAfflictionLimb(targetCharacter, "internaldamage", limbtype, 4 + math.random() * 6,
                            usingCharacter)
                    ...
                    elseif ishead then
                        ...
                        HF.AddAfflictionLimb(targetCharacter, "internaldamage", limbtype, 10 + math.random() * 10,
                            usingCharacter)
                        HF.AddAfflictionLimb(targetCharacter, "bleeding", limbtype, 6 + math.random() * 12,
                            usingCharacter)
                    else
    ...
    if mode ~= "none" then
        Timer.Wait(function() item.Tags = "multiscalpel_" .. mode end, 50)
    end
end
